...
func TestApplyExchangeRate(t *testing.T) {
	tt := map[string]struct {
		...
		"Amount(1.52) * rate(1)": {
			...
			expected: Amount{
				quantity: Decimal{subunits: 15200, precision: 4},
		...
		"Amount(4) * rate(2.5)": {
			in: Amount{
				quantity: Decimal{subunits: 4, precision: 0},
			},
			rate:           ExchangeRate{subunits: 25, precision: 1},
			targetCurrency: Currency{code: "TRG", precision: 0},
			expected: Amount{
				quantity: Decimal{subunits: 10, precision: 0},
				currency: Currency{code: "TRG", precision: 0},
			},
		},
		"Amount(3.14) * rate(2.52678)": {
			in: Amount{
				quantity: Decimal{subunits: 314, precision: 2},
			},
			rate:           ExchangeRate{subunits: 252678, precision: 5},
			targetCurrency: Currency{code: "TRG", precision: 2},
			expected: Amount{
				quantity: Decimal{subunits: 793, precision: 2},
				currency: Currency{code: "TRG", precision: 2},
			},
		},
		"Amount(1.1) * rate(10)": {
			in: Amount{
				quantity: Decimal{subunits: 11, precision: 1},
			},
			rate:           ExchangeRate{subunits: 10, precision: 0},
			targetCurrency: Currency{code: "TRG", precision: 1},
			expected: Amount{
				quantity: Decimal{subunits: 110, precision: 1},
				currency: Currency{code: "TRG", precision: 1},
			},
		},
		"Amount(1_000_000_000.01) * rate(2)": {
			in: Amount{
				quantity: Decimal{subunits: 1_000_000_000_01, precision: 2},
			},
			rate:           ExchangeRate{subunits: 2, precision: 0},
			targetCurrency: Currency{code: "TRG", precision: 2},
			expected: Amount{
				quantity: Decimal{subunits: 2_000_000_000_02, precision: 2},
				currency: Currency{code: "TRG", precision: 2},
			},
		},
		"Amount(265_413.87) * rate(5.05935e-5)": {
			in: Amount{
				quantity: Decimal{subunits: 265_413_87, precision: 2},
			},
			rate:           ExchangeRate{subunits: 505935, precision: 10},
			targetCurrency: Currency{code: "TRG", precision: 2},
			expected: Amount{
				quantity: Decimal{subunits: 1342, precision: 2},
				currency: Currency{code: "TRG", precision: 2},
			},
		},
		"Amount(265_413) * rate(1)": {
			in: Amount{
				quantity: Decimal{subunits: 265_413, precision: 0},
			},
			rate:           ExchangeRate{subunits: 1, precision: 0},
			targetCurrency: Currency{code: "TRG", precision: 3},
			expected: Amount{
				quantity: Decimal{subunits: 265_413_000, precision: 3},
		...
		"Amount(2) * rate(1.337)": {
			...
			expected: Amount{
				quantity: Decimal{subunits: 267_400, precision: 5},
